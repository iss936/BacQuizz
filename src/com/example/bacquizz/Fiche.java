...
public class Fiche extends ListActivity {
	...
	private void fillData() {
		Cursor notesCursor = mDbHelper.fetchAllFiches();
		startManagingCursor(notesCursor);

		// Create an array to specify the fields we want to display in the list
		// (only TITLE)
		String[] from = new String[] { FichesDbAdapter.KEY_TITLE };
	...
	private void createFiche() {
		Intent i = new Intent(this, FicheEdit.class);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(this, FicheEdit.class);
		i.putExtra(FichesDbAdapter.KEY_ROWID, id);
